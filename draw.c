...
void add_curve( struct matrix *points, 
  ...
  double t, xcor, ycor, xcor1, ycor1;
  ...
  ycor = y0;
  for (t = step; t < 1; t += step) {
    xcor1 = xcoef -> m[0][0] * pow(t,3) + xcoef -> m[1][0] * pow(t,2) + xcoef -> m[2][0] * t + xcoef -> m[3][0];
    ycor1 = ycoef -> m[0][0] * pow(t,3) + ycoef -> m[1][0] * pow(t,2) + ycoef -> m[2][0] * t + ycoef -> m[3][0];
